...
* It will let know the player if number is close or far,
...
7. If it is wrong and the player has turns left:
        *Tell the player they are wrong and whether their guess was close or too far.
        *Allow them to enter another guess.
        *Decrement the turn number by 1.
